...
def test_syllabi_word_template_with_tabular_assessments():
    file_path = "tests/data/syllabi/TEST101_2025W1_Word_Tabular_Assessments.docx"
    ab_path = os.path.abspath(file_path)
    file_name = "TEST101_2025W1_Word_Tabular_Assessments.docx"
    course_instance = sp.get_course_from_text_file(ab_path, file_name)
...
def test_syllabi_word_template_with_assessments_with_brackets():
    file_path = "tests/data/syllabi/TEST101_2025W1_Word_Assessments_with_brackets.docx"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_pdf_template_CLOs_without_bullets():
    file_path = "tests/data/syllabi/TEST101_2025W1_PDF_Without_Bullet_CLOs.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_pdf_template_without_course_title_table():
    file_path = "tests/data/syllabi/TEST101_2025W1_Without_Course_Title_table.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_file_name_without_course_code_number_and_term():
    file_path = "tests/data/syllabi/FileNameWithoutCode&Term.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_file_name_without_course_code_number_term_and_multiple_codes_in_file():
    file_path = "tests/data/syllabi/FilenameWithoutCode&MultipleCodeInFile.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_different_layout():
    file_path = "tests/data/syllabi/DifferentLayoutSyllabus.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_different_layout_assessments_percentage_seperated():
    file_path = "tests/data/syllabi/DifferentLayoutSyllabusWithComponentsPrecentageSeperated.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_description_with_additional_section():
    file_path = "tests/data/syllabi/TEST101_Syllabus_Description_With_Additional_Section.pdf"
    ab_path = os.path.abspath(file_path)
...
def test_syllabi_CLOs_with_prefixed():
    file_path = "tests/data/syllabi/TEST101_2025W1_CLOs_with_prefixes.pdf"
    ab_path = os.path.abspath(file_path)
